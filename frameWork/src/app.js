...
import MainPage from './components/atlantis/MainPage';
import Dispatcher from './core/Dispatcher';
import AppActions from './actions/AppActions';
import ActionTypes from './constants/ActionTypes';
import TodoApp from './fluxDemo/flux-todomvc/js/components/TodoApp.react';
...
function run() {
  ...
  let element = React.createElement(MainPage, props);
  //let element = React.createElement(TodoApp, props);
